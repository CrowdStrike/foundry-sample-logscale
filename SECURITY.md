...
This document outlines security policy and procedures for the CrowdStrike `foundry-sample-logscale` project.
...
+ Submitting
  a [bug](https://github.com/CrowdStrike/foundry-sample-logscale/issues/new?assignees=&labels=bug+%3Abug%3A&template=bug_report.md&title=%5B+BUG+%5D+...).
+ Submitting a [pull request](https://github.com/CrowdStrike/foundry-sample-logscale/pulls) to potentially resolve the issue. (New
